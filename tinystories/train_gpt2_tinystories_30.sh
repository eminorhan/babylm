...
#SBATCH --mem=240GB
#SBATCH --time=6:00:00
#SBATCH --job-name=train_gpt2_tinystories_30
#SBATCH --output=train_gpt2_tinystories_30_%A_%a.out
#SBATCH --array=0
...
accelerate launch --config_file accelerate_1gpu_config.yaml --num_cpu_threads_per_process 16 /scratch/eo41/babylm/train.py \
    ...
    --train_files "data/tinystories/TinyStoriesV2-GPT4-train-30.json" \
