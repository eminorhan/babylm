...
accelerate launch --config_file accelerate_1gpu_config.yaml --num_cpu_threads_per_process 16 /scratch/eo41/babylm/train.py \
    ...
    --train_files "data/train_100M/childes.txt" \
                  "data/train_100M/bnc_spoken.txt" \
                  "data/train_100M/gutenberg.txt" \
                  "data/train_100M/open_subtitles.txt" \
                  "data/train_100M/simple_wiki.txt" \
                  "data/train_100M/switchboard.txt" \
